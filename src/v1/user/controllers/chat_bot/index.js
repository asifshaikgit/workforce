...
const chatBotService = require('../../services/chat_bot/index');

/**
 * Third party Chat Bot API integration
 *
 * Logic:
...
const index = tryCatch(
    async (req, res) => {
        ...
        /* Log Request */
        logRequest('info', req, "Chat Bot API request");
        /* Log Request */
        ...
        */
        if (errors.isEmpty()) {
            let responseData;
            var response = await chatBotService.index(req.body);
            if (response.status) {
            ...
            /* Log Response */
            logResponse("info", req, responseData, "Chat Bot API Response");
            /* Log Response */
